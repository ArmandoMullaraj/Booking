    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="form-group">
                ...
                <input type="text" name="location" onChange={handleChange} placeholder="Enter Location" className="form-control ml-2 mr-2" />
                {/*<AlgoliaPlaces
            ...
            */}
                ...
                <DatePicker
                 ...
                 onChange={(date, dateString) =>
                  ...
                  disabledDate={(current) => current && current.valueOf() < moment().subtract(1, 'days')} // we do this so the user cant pick any dates from yesterday
                  />
